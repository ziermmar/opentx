...
const char STR_OPEN9X[]  =
    ...
    ISTR(R9MLITE_FCC_POWER_VALUES)
    ISTR(R9MLITE_LBT_POWER_VALUES)
...
const char STR_PCBREV_ERROR[]  = TR_PCBREV_ERROR;
...
const char STR_EEBACKUP[]  = TR_EEBACKUP;
const char STR_FACTORYRESET[]  = TR_FACTORYRESET;
...
const char STR_BLCOLOR[]   = TR_BLCOLOR;
  ...
  const char STR_MAINVIEWX[]  = TR_MAINVIEWX;
